                                ...
                                <div className="card-body px-3">                                    
                                        <div className="top">
                                                ...
                                                <div className='d-flex justify-content-between align-items-center'>
                                                        ...
                                                        <Button variant="outline-danger" onClick={() => { decreaseQuantity(e.id) }}><strong> - </strong></Button>
                                                        <div style={{marginRight: '5px',marginLeft:'5px'}}>{e.quantity}</div>
                                                        <Button variant="outline-success" onClick={() => { increaseQuantity(e.id) }}><b> + </b></Button>   
                                                </div>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div className="bottom">
                                        ...
                                        <div className='d-flex justify-content-between align-items-center h2 mt-3'>
                                            Total Amount : 
                                            <h5 className="card-text"><strong>${e.quantity*price - e.quantity*discountPrice }</strong></h5>
                                        </div>
                                    </div>
